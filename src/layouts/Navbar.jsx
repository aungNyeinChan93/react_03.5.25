        ...
        <React.Fragment>
            <header className="bg-white dark:bg-gray-900">
                <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
                    <NavLink className={({ isActive }) => isActive ? 'block text-red-600 dark:text-red-300' : 'block text-teal-600 dark:text-teal-300'} to="/" >
                    ...
                    <div className="flex flex-1 items-center justify-end md:justify-between">
                        <nav aria-label="Global" className="hidden md:block">
                            <ul className="flex items-center gap-6 text-sm">
                                ...
                                <li>
                                    <NavLink
                                        className={({ isActive }) => (isActive ? 'text-red-500 transition hover:text-red-500/75 dark:text-white dark:hover:text-white/75' : "text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75")}
                                        to="products"
                                    >
                                        Products
                                    </NavLink>
